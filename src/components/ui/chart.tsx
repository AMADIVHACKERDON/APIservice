...
const ChartTooltipContent = React.forwardRef<
  HTMLDivElement,
  // Recharts typings vary across versions; accept any here and narrow locally
  any &
    React.ComponentProps<"div"> & {
      hideLabel?: boolean;
                      ...
                      {itemConfig?.icon ? (
                        ...
                        !hideIndicator && (
                          <div
                            ...
                            style={{
                              ...(indicatorColor ? { ["--color-bg" as any]: indicatorColor } : {}),
                              ...(indicatorColor ? { ["--color-border" as any]: indicatorColor } : {}),
